...
export class AccessPageService {
  private urlMain = 'http://localhost:5147/api/accesspage';
  ...
  addNewPage(newPageData: { roleId: number, pageId: string }): Observable<AccessPageModel[]> {
    const url = `http://localhost:5147/api/accesspage`;
  ...
  getAllPages(): Observable<AccessPageModel[]> {
    const getAllUrl = `http://localhost:5147/api/page`;
  ...
  getAllRoles(): Observable<AccessPageModel[]> {
    const getAllRolesUrl = `http://localhost:5147/api/role`;
  ...
  deletePage(id: number): Observable<AccessPageModel[]> {
    const deleteUrl = `http://localhost:5147/api/accesspage/${id}`;
