...
export class AccessPageService {
  private urlMain = ' http://10.10.10.13:5000/api/accesspage';
  ...
  addNewPage(newPageData: { roleId: number, pageId: string }): Observable<AccessPageModel[]> {
    const url = ` http://10.10.10.13:5000/api/accesspage`;
  ...
  getAllPages(): Observable<AccessPageModel[]> {
    const getAllUrl = ` http://10.10.10.13:5000/api/page`;
  ...
  getAllRoles(): Observable<AccessPageModel[]> {
    const getAllRolesUrl = ` http://10.10.10.13:5000/api/role`;
  ...
  deletePage(id: number): Observable<AccessPageModel[]> {
    const deleteUrl = ` http://10.10.10.13:5000/api/accesspage/${id}`;
